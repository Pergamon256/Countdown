...
countdown(result) #This is in (minutes, seconds) format, so change the values to increase or decrease the timer. (1,0) would be a 1 minute countdown, (0,5) would be a 5 second countdown, (5,10) would be a 5 minute 10 second countdown, etc.